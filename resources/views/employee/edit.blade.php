    ...
    <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
      ...
      <div class="x_panel">
        <div class="x_content">
          ...
          <div class="row row-mb-0">
            @include('partials._psgc_address', ['model' => $user])
          </div>
...
<!-- {!! JsValidator::formRequest('App\Http\Requests\EmployeeAddEditFormRequest', '#employee_edit_form') !!} -->
 {!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\EmployeeAddEditFormRequest', '#employee_add_form'), 1) !!}
