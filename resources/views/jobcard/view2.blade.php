...
?>
    ...
    // <script nonce="{{ $cspNonce }}" src="{{ URL::asset('vendors/moment/min/moment.min.js') }}"></script>
    // <script nonce="{{ $cspNonce }}" src="{{ URL::asset('vendors/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
    // <script nonce="{{ $cspNonce }}" src="{{ URL::asset('vendors/bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js') }}"></script>
    <!-- datetimepicker -->
    <script nonce="{{ $cspNonce }}">
