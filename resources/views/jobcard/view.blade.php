                                                ...
                                                <table class="table table-bordered table-sm main_data_points f-14" id="main_data_points" align="center">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="fw-bold" style="width:8%;">
    ...
    <?php } else {
        foreach ($data as $datas) { ?>
            ...
            <tr class="obs_point_data" id="<?php echo 'row_id_delete_' . $i; ?>">
                ...
                <td>
                    <input type="text" name="product2[qty][]" class="form-control qtyt qnt_<?php echo $i; ?> <?php echo 'qty_' . $i; ?>" row_id1="<?php echo $i; ?>" value="<?php echo $datas->quantity; ?>" url="<?php echo url('/jobcard/gettotalprice'); ?>" prd_url="<?php echo url('/sale_part/get_available_product'); ?>" id="<?php echo 'qty_' . $i; ?>" style="width:100%;float:left;">
                </td>
                <td>
...
<!-- /page content -->
<script nonce="{{ $cspNonce }}">// Function to populate prices for pre-selected products on page load
...
<script nonce="{{ $cspNonce }}">
    ...
    // });
        ...
        $('body').on('change keyup', '.qtyt', function() {
            ...
            var msg5 = "{{ trans('message.Product Not Available') }}";
            var msg6 = "{{ trans('message.Current Stock :') }}";
            var msg7 = "{{ trans('message.First select product name') }}";
