    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12">
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    @can('customer_add')
                    <a href="{!! url('/import/user') !!}" class="nav-link active"><span class="visible-xs"></span><i class="fa-solid fa-file-import fa-lg"></i><b> {{ trans('message.Import Users') }}</b></a>
                    @endcan
                </li>
                <li class="nav-item">
                    @can('customer_add')
            ...
            <div class="x_panel">
                <div class="x_content">
                    <form id="import_form" action="{{ route('importuser') }}" method="post" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="row col-md-5 col-lg-5 col-xl-5 col-xxl-5 col-sm-5 col-xs-5 form-group my-form-group has-feedback">
                                <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 mt-2" for="image">
                                    {{ trans('message.Select File') }} </label>
