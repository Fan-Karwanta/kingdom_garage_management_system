			...
			<div class="x_panel">
				<div class="x_content">
					<form id="branchAddForm" method="post" action="{!! url('branch/store') !!}" enctype="multipart/form-data" class="form-horizontal branchAddForm">
						...
						<div class="row row-mb-0">
							@include('partials._psgc_address', ['addressName' => 'branch_address'])
						</div>
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\StoreBranchAddEditFormRequest', '#branchAddForm'), 1) !!}
