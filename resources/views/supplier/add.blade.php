...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\SupplierAddEditFormRequest', '#supplier_add_form'), 1) !!}
...
<link rel="stylesheet" href="{{ URL::asset('vendors/bootstrap/dist/css/bootstrap-float-label.min.css') }}" />
@endsection