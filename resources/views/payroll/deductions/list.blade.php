...
<div class="right_col" role="main">
            ...
            <div class="nav_menu">
                <nav>
                    <div class="nav toggle">
                        ...
                        <span class="titleup">Employee Deductions
                            <a href="{{ url('/payroll/deductions/add') }}" class="addbotton">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <table id="deductionTable" class="table jambo_table" style="width:100%">
                    <thead>
                        <tr>
                            <th>Employee</th>
                            <th>Type</th>
