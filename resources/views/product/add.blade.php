          ...
          <form id="productAdd-Form" method="post" action="{{ url('/product/store') }}" enctype="multipart/form-data" class="form-horizontal upperform productAddForm">
            ...
            <div class="row row-mb-0">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 {{ $errors->has('price') ? ' has-error' : '' }} my-form-group">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="price" name="price" class="form-control" placeholder="{{ trans('message.Enter Product Cost') }}" value="{{ old('price') }}" maxlength="10" required>
                  @if ($errors->has('price'))
            ...
            <div class="row">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                <input type="text" id="margin" name="margin" class="form-control" placeholder="{{ trans('message.Enter Product Margin') }} (ex: 10.5%)" value="{{ old('sellingprice') }}" maxlength="10">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 mt-2">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <input type="text" id="sellingprice" name="sellingprice" class="form-control" value="{{ old('sellingprice') }}" maxlength="10" readonly>
                    @if ($errors->has('price'))
                    <span class="help-block">
                      <strong>{{ $errors->first('price') }}</strong>
                    </span>
