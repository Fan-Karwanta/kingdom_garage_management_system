                            ...
                            <table class="table table-bordered adddatatable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left">{{ trans('message.Discount') }}(%) </th>
                                        <th class="text-left">{{ trans('message.Tax') }}(%)</th>
                                ...
                                <table class="table table-bordered adddatatable mx-0">
                                    ...
                                    <div class="row table-responsive">
                                        <table class="table table-bordered quotation_total">
                                            ...
                                            if($plainTerms != '') { echo '<td class="terms_condition" rowspan="3" style="width:51%;vertical-align: top !important; font-family:Google Sans, Roboto, arial, sans-serif">';echo '&nbsp;&nbsp;<b>'.trans("message.Terms & Condition").' </b><br><br>'; echo $logo->terms_and_condition; echo '</td>';} ?>
