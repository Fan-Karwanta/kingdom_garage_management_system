...
<body>
    ...
    <div class="row">
        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12 col-sm-12 col-xs-12 modal-footer mx-3">
            <button type="button" class="btn btn-outline-secondary printbtn btn-sm mx-2 pdfbutton" id="printBtn" target="_blank" ><img src="{{ URL('public/img/icons/Print (1).png') }}" class="pdfButton"></button>
