    ...
    <div class="row me-4 pe-1">
        <div class="col-md-12 col-sm-12 col-xs-12 ms-lg-2">
            ...
            <div class="ps-0 modal-footer mpPrintPdfCloseButtonForSmallDevices">
                <button type="button" class="btn btn-outline-secondary btn-sm printbtn mx-2 ms-0" id="printBtn"><img src="{{ URL('public/img/icons/Print (1).png') }}" class="pdfButton"></button>
