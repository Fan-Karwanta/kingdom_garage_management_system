      ...
      <div class="x_content">
        <form id="demo-form2" action="{!! url('/customer/store') !!}" method="post" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left input_mask customerAddForm">
          ...
          <div class="row row-mb-0">
            ...
            <label class="control-label col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4" for="mobile">{{ trans('message.Mobile No') }}  @if($settings->customer_login == 1 && $settings->is_mobile == 0) <label class="color-danger">*</label> @endif </label>
          ...
          <div class="row row-mb-0">
            ...
            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                ...
                <input type="password" name="password" placeholder="{{ trans('message.Enter Password') }}" value="{{ old('password', 'Kingdom@2026') }}" class="form-control col-md-7 col-xs-12" maxlength="20">
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\CustomerAddEditFormRequest', '#demo-form2'), 1) !!}
