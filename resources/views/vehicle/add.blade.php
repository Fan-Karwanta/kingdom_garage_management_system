                            ...
                            <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4">
                                    <div class="select-wrapper d-flex">
                                        ...
                                        <div class="arrow-icon-vehicle">
        
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 col-sm-4 col-xs-4 ml-2 addremove">
...
<script nonce="{{ $cspNonce }}">
    ...
    $(document).ready(function() {
        ...
        $(document).on('hidden.bs.modal', '.modal', function () {
            ...
            $('body').css('padding-right', '');  // reset Bootstrap inline style
        });
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            swal({
                                ...
                                $('#responsive-modal-color').modal('hide'); // Close the 
                                $('.modal-backdrop').remove();
                                $('body').removeClass('modal-open');
                                $('body').css('padding-right', '');
                            });
