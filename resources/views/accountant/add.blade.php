            ...
            <div class="row row-mb-0">
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  ...
                  <input type="password" name="password" placeholder="{{ trans('message.Enter Password') }}" value="{{ old('password', 'Kingdom@2026') }}" maxlength="20" class="form-control">
              ...
              <div class="row col-md-6 col-lg-6 col-xl-6 col-xxl-6 col-sm-6 col-xs-6 form-group my-form-group has-feedback {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                ...
                <div class="col-md-8 col-lg-8 col-xl-8 col-xxl-8 col-sm-8 col-xs-8">
                  <div class="password-input-wrap">
                  <input type="password" name="password_confirmation" placeholder="{{ trans('message.Enter Confirm Password') }}" value="{{ old('password_confirmation', 'Kingdom@2026') }}" maxlength="20" class="form-control">
                  <span class="password-toggle-btn"><i class="fa fa-eye"></i></span>
                  </div>
...
{!! preg_replace('/<script\b(?![^>]*\bnonce=)[^>]*>/i', '<script nonce="'.e($cspNonce).'">', (string) JsValidator::formRequest('App\Http\Requests\AccountantAddEditFormRequest', '#accountant_add_form'), 1) !!}
