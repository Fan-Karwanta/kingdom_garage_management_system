    ...
    public function record_sales(Request $request)
    {
        ...
        if (isAdmin(Auth::User()->role_id)) {
            ...
            if ($s_date == '' && $e_date == '' && $all_customer == 'all' && $all_salesman == 'all') {
                ...
                $salesreport = Sale::whereBetween('date', [$s_date, $e_date])->where([['salesmanname', '=', $all_salesman], ['customer_id', '=', $all_customer]])->where([['soft_delete', 0], ['branch_id', $adminCurrentBranch->branch_id]])->get();
            }
        } elseif (getUsersRole(Auth::user()->role_id) == 'Customer') {
            ...
            if ($s_date == '' && $e_date == '' && $all_customer == 'all' && $all_salesman == 'all') {
                ...
                $salesreport = Sale::whereBetween('date', [$s_date, $e_date])->where([['salesmanname', '=', $all_salesman], ['customer_id', '=', $all_customer]])->get();
            }
        } else {
            $Select_salesman = User::where([['role', '=', 'employee'], ['soft_delete', 0], ['branch_id', $currentUser->branch_id]])->get();
            if ($s_date == '' && $e_date == '' && $all_customer == 'all' && $all_salesman == 'all') {
                ...
                $salesreport = Sale::whereBetween('date', [$s_date, $e_date])->where([['salesmanname', '=', $all_salesman], ['customer_id', '=', $all_customer]])->where([['soft_delete', 0], ['branch_id', $currentUser->branch_id]])->get();
            }
        }
    ...
    public function employeeservice(Request $request)
    {
        ...
        if (isAdmin(Auth::User()->role_id)) {
            if ($s_date == '' && $e_date == '' && $all_employee == 'all') {
                ...
                $servicereport = Service::where([['done_status', '=', 1], ['soft_delete', 0]])->whereBetween('service_date', [$s_date, $e_date])->orderBy('id', 'desc')->get();
            } elseif ($s_date == '' && $e_date == '' && $all_employee != 'all') {
                $title_report = 'All Service';
                $date_report = 'Year';
                $title = 'Service';
            ...
            if ($s_date == '' && $e_date == '' && $all_employee == 'all') {
                ...
                $servicereport = Service::where('done_status', '=', 1)->whereBetween('service_date', [$s_date, $e_date])->orderBy('id', 'desc')->get();
            } elseif ($s_date == '' && $e_date == '' && $all_employee != 'all') {
                $title_report = 'All Service';
                $date_report = 'Year';
                $title = 'Service';
            ...
            if ($s_date == '' && $e_date == '' && $all_employee == 'all') {
                ...
                $servicereport = Service::where([['done_status', '=', 1], ['soft_delete', 0], ['branch_id', $currentUser->branch_id]])->whereBetween('service_date', [$s_date, $e_date])->orderBy('id', 'desc')->get();
            } elseif ($s_date == '' && $e_date == '' && $all_employee != 'all') {
                $title_report = 'All Service';
                $date_report = 'Year';
                $title = 'Service';
